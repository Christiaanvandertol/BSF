function [O2A,O2B] = retrievalF(wl,E,piL,opt,aprior,cos_sza,cos_vza,priorweight,p,SRCA,SRCB)
...
for O2band = 1:2
    ...
    [~,a,piLr]       = cost4F(F,input); % the slope of the regression, which is the ratio of optical depths
